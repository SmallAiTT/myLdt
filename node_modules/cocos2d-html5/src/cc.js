...
//                    updateLoading(loaded / que.length);
    ...
    cc.loadGame = function(){
        cc._loadJsList4Dependency("", [cc._projDir + cc.CFG_DIR  + "res.js", "cocos2d.js"], 0, function(){
            ...
            cc.loadJson(cc._projDir + "/" + cc.COCOS_JSON, function(err, data){
                if(err){
                    ...
                    var localBaseJsList = baseJsList || null;
                    if(localBaseJsList && localBaseJsList.length > 0){
                        cc._loadJsList("", localBaseJsList, 0, function(){
